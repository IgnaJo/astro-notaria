...
const ValidateDocumentForm = () => {
  ...
  const blurFilter = 'w-[780px] h-[100%]'
  ...
  {/* Indicador de carga */}
  {isLoading && (
    <div role="status" class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 transition-opacity duration-500">
      <svg 
        aria-hidden="true" 
        class="w-20 h-auto text-gray-200 animate-spin dark:text-gray-600 fill-primary" 
        viewBox="0 0 100 101" 
        fill="none" 
  ...
  {/* Mostrar iframe cuando el PDF está disponible */}
  {!isLoading && pdfUrl && (
    <iframe
      src={pdfUrl}
